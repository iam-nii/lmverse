    ...
    content: {
        ...
        ctaCards: {
            ...
            newsletter: {
                title: t({
                    en: "Transform Access",
                    ru: "Трансформируйте доступ",
                    fr: "Accès Transformateur",
                }),
                description: t({
                    en: "Create an account to receive our newsletter course promotions.",
                    ru: "Создайте аккаунт, чтобы получать наши новостные рассылки и акции на курсы.",
                    fr: "Créez un compte pour recevoir nos promotions de cours par newsletter.",
                }),
                button: t({
