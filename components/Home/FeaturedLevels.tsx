...
const levels = [
    {
        ...
        image: "/language_levels/starter.jpg",
    },
    {
        id: 2,
        tag: "A1 - A2",
    ...
    },
    {
        ...
        image: "/language_levels/intermediate.jpg",
    },
    {
        id: 4,
        tag: "C1 - C2",
    ...
    return (
        <section className="py-16 md:py-20 md:px-40 px-5">
            <div className="flex justify-between items-center mb-8">
                <div>
                    <p className="text-secondary font-semibold text-sm mb-1">What&apos;s New</p>
                    ...
                    >
                        ...
                        <div className="p-5 flex flex-col flex-1">
                            ...
                            <div className="mt-4 pt-4 border-t border-border">
                                <Button className="bg-primary text-white rounded-full text-sm px-6">
                                    🛒 Book a consultation
                                </Button>
                            </div>
                        </div>
