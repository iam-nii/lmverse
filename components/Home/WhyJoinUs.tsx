    ...
    return (
        <section className="py-16 md:py-20 md:px-40 px-5">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center overflow-hidden">
                ...
                >
                    <div className="relative w-full max-w-sm h-72 rounded-2xl bg-gradient-to-br from-amber-50 to-orange-50 dark:from-slate-800 dark:to-slate-700 border border-border flex items-center justify-center overflow-hidden hover:scale-105 transition-transform duration-500 shadow-sm cursor-default">
                ...
                >
                    <h2 className="text-2xl md:text-3xl font-bold mb-4">{whyJoinUs.title}</h2>
