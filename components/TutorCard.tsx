...
export default function TutorCardWithAvatar({
  ...
  return (
    <div
      className={`max-w-sm rounded-[1rem] shadow-sm hover:shadow-xl overflow-hidden border transition-all duration-300 flex flex-col ${bgClass}`}
    >
      <div className="p-6 pb-0 flex-1">
        ...
        <div className="flex items-start gap-4 mb-4">
          ...
          <div className="flex flex-col gap-1 w-full mt-1">
            ...
            <div className="flex items-center gap-1.5 mt-1">
              <h3
                className={`text-lg font-bold leading-tight line-clamp-1 ${textTitleClass}`}
              >
        ...
        {/* About section */}
        <p
          className={`text-sm leading-relaxed mb-6 line-clamp-2 ${textBodyClass}`}
        >
        ...
        <div className="grid grid-cols-3 gap-2 mb-6">
          <div className="flex flex-col items-center text-center">
            ...
            <span className={`font-semibold text-sm ${statValClass}`}>
              {lessonsCount}
            </span>
      ...
      {/* Footer with CTA */}
      <div
        className={`px-6 py-4 flex items-center justify-end mt-auto ${footerBgClass}`}
      >
        <button
          onClick={onViewMore}
