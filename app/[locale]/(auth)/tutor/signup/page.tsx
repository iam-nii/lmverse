...
export default function TutorSignup() {
        ...
        return (
            <div className="w-full animate-in fade-in duration-500 flex flex-col items-center text-center gap-6 py-8">
                ...
                <div className="space-y-3">
                    <h2 className="text-2xl font-bold text-slate-900 dark:text-white">{tTutor("pendingTitle")}</h2>
    ...
    return (
        <div className="w-full space-y-6 animate-in fade-in duration-500">
            {/* Title */}
            <div>
                <h2 className="text-3xl font-extrabold text-slate-900 dark:text-white leading-tight">{tTutor("title")}</h2>
                <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">{tTutor("subtitle")}</p>
            </div>
                ...
                <div className="flex items-start">
                    ...
                    <div className="ml-3 text-sm">
                        <label htmlFor="terms" className="text-slate-600 dark:text-slate-400">
                            {tSignup("agreement1")}{' '}
                            <a href="#" className="font-medium text-blue-600 dark:text-blue-400 hover:underline">{tSignup("terms")}</a>{' '}
                            {tSignup("and")}{' '}
                            <a href="#" className="font-medium text-blue-600 dark:text-blue-400 hover:underline">{tSignup("privacy")}</a>
                        </label>
                    </div>
                </div>
            ...
            <div className="text-center mt-6 pt-4 border-t border-slate-100 dark:border-slate-800">
                <p className="text-sm text-slate-500 dark:text-slate-400">
                    {tSignup("haveAccount")}{' '}
                    <Link href={`/${locale}/tutor/login`} className="font-semibold text-blue-600 dark:text-blue-400 hover:underline transition-all">
                        {tSignup("loginLink")}
                    </Link>
                </p>
            </div>
