...
export default function ForgotPassword() {
    ...
    return (
        <div className="w-full space-y-8 animate-in fade-in duration-500">
            {/* Title */}
            <div>
                <h2 className="text-3xl font-extrabold text-slate-900 dark:text-white leading-tight">Reset your password</h2>
            ...
            <div className="text-center mt-6 pt-4 border-t border-slate-100 dark:border-slate-800 flex justify-center items-center gap-2">
                <span className="text-sm text-slate-500">Remembered your password?</span>
