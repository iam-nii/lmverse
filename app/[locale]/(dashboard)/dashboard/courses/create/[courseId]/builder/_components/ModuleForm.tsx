...
export default function ModuleForm(){
    ...
    return (
        <div className="mt-8 flex flex-col gap-8 justify-items-center">
                <Dialog>
                    <DialogTrigger asChild><Button variant="outline" className="self-start">Add a new module</Button></DialogTrigger>
                    <DialogContent>
                    <form action={handleAddModule} className="flex flex-col gap-4">
                        <DialogHeader>
                        <DialogTitle>Create a new module</DialogTitle>
                        <DialogDescription>
                            Modules help structure your course into logical sections. Each module can
                            contain one or more lessons, allowing you to organize content from basic
